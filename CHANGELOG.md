...
- APIキーコピーフローの安定化とE2Eテスト改善 (#404)
- ロードバランサーの失効アクティブカウンタによるキュータイムアウトを防止 (#402)
- ダッシュボードのボタン視認性・押下フィードバック改善 (SPEC-adc9200e) (#400)
- direct-routeロード漏洩防止と部分エクスポート失敗修正 (#399)
- ダッシュボードトップカードのリクエスト合計を永続化 (#398)
...
* **web:** unify chat ui under /chat ([3817a64](https://github.com/akiojin/runtime-router/commit/3817a64c93f8ba679d9e077af925e0d0368801fd))


### Bug Fixes

* **readme:** enhance overview description with scalability focus ([3549ec0](https://github.com/akiojin/runtime-router/commit/3549ec08e8c4788d44a2abd3b934995423647920))
* **readme:** enhance overview description with scalability focus ([34289f7](https://github.com/akiojin/runtime-router/commit/34289f7623e3afbcb5bb525aceabd1e5aa43825a))
* **readme:** enhance overview description with scalability focus ([14fa626](https://github.com/akiojin/runtime-router/commit/14fa6264028c96f44a88b063fb1389c1b6d68d57))

## [2.1.8](https://github.com/akiojin/runtime-router/compare/v2.1.7...v2.1.8) (2025-11-21)


### Bug Fixes

* **readme:** enhance advanced load balancing description ([a45d3bb](https://github.com/akiojin/runtime-router/commit/a45d3bbb816741a3f778c5d65e134129d7f5ec5b))
* **readme:** enhance advanced load balancing description ([249b2fd](https://github.com/akiojin/runtime-router/commit/249b2fd66d6de9110fd19e779318a277f3961fd2))

## [2.1.6](https://github.com/akiojin/runtime-router/compare/v2.1.5...v2.1.6) (2025-11-21)


### Bug Fixes

* **readme:** improve load balancing description clarity ([e6afabb](https://github.com/akiojin/runtime-router/commit/e6afabbc70ff455ec9acbf5f32c8a48c16205445))
* **readme:** improve load balancing description clarity ([3cc6c7c](https://github.com/akiojin/runtime-router/commit/3cc6c7c279040039998aff05f578123e3ee81d0e))

## [2.1.5](https://github.com/akiojin/runtime-router/compare/v2.1.4...v2.1.5) (2025-11-21)


### Bug Fixes

* **readme:** enhance monitoring feature description ([23498a7](https://github.com/akiojin/runtime-router/commit/23498a7fd1d8ff02e5144de8b72efd200cb032ef))
* **readme:** enhance monitoring feature description with performance metrics ([df91e15](https://github.com/akiojin/runtime-router/commit/df91e15c30537b0477e2770a571b6e36c4b5c324))

## [2.1.4](https://github.com/akiojin/runtime-router/compare/v2.1.3...v2.1.4) (2025-11-21)


### Bug Fixes

* **readme:** improve load balancing feature description ([856385f](https://github.com/akiojin/runtime-router/commit/856385fab34a962ee96d9c3085c8cb5cc26d6bf2))
* **readme:** improve load balancing feature description ([123a4f9](https://github.com/akiojin/runtime-router/commit/123a4f9bb41a7a437594ac42f967378ddfd00e63))

## [2.1.3](https://github.com/akiojin/runtime-router/compare/v2.1.2...v2.1.3) (2025-11-21)


### Bug Fixes

* **router:** sync readiness after node registration ([147f414](https://github.com/akiojin/runtime-router/commit/147f414c306ef21177b74527b93846ce6e3fc223))

## [2.1.2](https://github.com/akiojin/runtime-router/compare/v2.1.1...v2.1.2) (2025-11-21)


### Bug Fixes

* **ci:** correct pwsh derive step in publish ([84471bd](https://github.com/akiojin/runtime-router/commit/84471bd77d7f202e32e84f37eb234ac6107824b0))
* **ci:** derive release version with pwsh on windows ([3787bd4](https://github.com/akiojin/runtime-router/commit/3787bd4481de0ad199a813c23b70a84ed697a093))
* **ci:** use pwsh syntax in windows derive step ([fb28310](https://github.com/akiojin/runtime-router/commit/fb28310740503c898cf181c528fb41a382703800))

## [2.1.1](https://github.com/akiojin/runtime-router/compare/v2.1.0...v2.1.1) (2025-11-20)
...
* **ci:** extract release version from commit message in publish workflow ([6bb1165](https://github.com/akiojin/runtime-router/commit/6bb11657d8a70b323819307fb53a10d0ad02e451))
* **ci:** skip ICE03 validation for Windows MSI build ([3391b7d](https://github.com/akiojin/runtime-router/commit/3391b7d0c120e249837ddd985c1da13d0dba9b15))
* **deps:** upgrade sqlx to 0.8.6 to address security vulnerability ([cef2542](https://github.com/akiojin/runtime-router/commit/cef2542b08144154a02546f29d763c9ef508c026)), closes [#3](https://github.com/akiojin/runtime-router/issues/3)
* **docs:** ワークフローファイル名を実際のファイル名に修正 ([b71d128](https://github.com/akiojin/runtime-router/commit/b71d1281653533a61c1679c3ab76a94d5c36830f))
* **installer:** move KeyPath from RemoveFolder to RegistryValue ([d23230e](https://github.com/akiojin/runtime-router/commit/d23230e5c2756be7f4feed3c17d537f57e97f220))
* **installer:** resolve ICE03 validation errors in WiX ([1303301](https://github.com/akiojin/runtime-router/commit/1303301196269fb3b3375feee443787f4b52e150))
* **release:** improve tag detection in release workflow ([c317474](https://github.com/akiojin/runtime-router/commit/c317474f8aed2b8d149559e0c8dd315cac28da92))
* **release:** improve workflow robustness with tag-based verification ([6f18acb](https://github.com/akiojin/runtime-router/commit/6f18acb7d19506cfa08aa7747b17861c81c3410a))
* **release:** resolve git fetch error in verify step ([7d3ce0c](https://github.com/akiojin/runtime-router/commit/7d3ce0c742f9cabb36c757dd7e68b8297f2c50fc))

## [2.0.4](https://github.com/akiojin/runtime-router/compare/v2.0.3...v2.0.4) (2025-11-19)


### Bug Fixes

* **build:** resolve wix per-user shortcut registry issues ([5ba4f71](https://github.com/akiojin/runtime-router/commit/5ba4f71222d0e2ae11ae0750f7270df01a1c1a54))

## [2.0.3](https://github.com/akiojin/runtime-router/compare/v2.0.2...v2.0.3) (2025-11-18)


### Bug Fixes

* **build:** set wix codepage to utf8 and shorten icon ids ([0e7a3af](https://github.com/akiojin/runtime-router/commit/0e7a3af0d459dad03b708a78328df2499180a9b5))

## [2.0.2](https://github.com/akiojin/runtime-router/compare/v2.0.1...v2.0.2) (2025-11-18)


### Bug Fixes

* **ci:** update mac runners and wix asset paths ([63f8107](https://github.com/akiojin/runtime-router/commit/63f8107d0d58bc771db48a120f54850597c3828e))

## [2.0.1](https://github.com/akiojin/runtime-router/compare/v2.0.0...v2.0.1) (2025-11-18)
...
* **build:** macOSネイティブビルドをサポート ([b3e5f6f](https://github.com/akiojin/runtime-router/commit/b3e5f6f50ee11646670100297ab91907a9edc062))
* **clippy:** drop redundant AgentError conversion in heartbeat ([68850ce](https://github.com/akiojin/runtime-router/commit/68850cec1bd881e7f3c187f628377440fed529cf))
* **models:** use existing glm4 9b q4_K_M manifest and align UI/specs ([6932729](https://github.com/akiojin/runtime-router/commit/6932729c8d0dbe89abfed82586e872f45ba57b13))
...
* resolve clippy and dead_code warnings ([ea90f2a](https://github.com/akiojin/runtime-router/commit/ea90f2ab4724a2b8b848ef5a9e54b19e454bcf63))
* resolve duplicate module and clippy issues ([50286a5](https://github.com/akiojin/runtime-router/commit/50286a5425071e4ee5ed4561dc193326c77b3da4))
* resolve duplicate module errors in integration tests ([59ce8d6](https://github.com/akiojin/runtime-router/commit/59ce8d69fe44434994723a842906d0570ea58728))
* **test:** add db_pool and jwt_secret to all AppState initializations ([e1624eb](https://github.com/akiojin/runtime-router/commit/e1624eb914a37408c05caaf041551a9262208a77))
* **test:** configure tests to run with single thread ([dd8769b](https://github.com/akiojin/runtime-router/commit/dd8769b2defe8f2b0cbb5b053f156181047df426))
* **test:** contract testsでヘルスチェックをスキップし全テスト成功 ([d161809](https://github.com/akiojin/runtime-router/commit/d161809737126702ce22124a8f30ae259d864720))
* **test:** dashboard_gpu_displayテストの期待ステータスコードを修正 ([8a0c66a](https://github.com/akiojin/runtime-router/commit/8a0c66a57efdc343585d597d327c9ff492b6fa11))
* **test:** model_info_testの期待ステータスコードを修正 ([fe131a0](https://github.com/akiojin/runtime-router/commit/fe131a0c4836ba6223726aaf8841dbced363d000))
* **test:** openai互換APIテストのモックエンドポイントをv1パスに修正 ([4aeaa9b](https://github.com/akiojin/runtime-router/commit/4aeaa9b7f3789ff9a568ce24e1b63415f391499d))
* **test:** openAI互換エンドポイントのテストにAPIキー認証を追加 ([21df080](https://github.com/akiojin/runtime-router/commit/21df0804c459bff45f74b3afe59630cc279f84c3))
* **test:** openai互換性テストでtest-modelをロード済みモデルに追加 ([e200313](https://github.com/akiojin/runtime-router/commit/e200313c37bb870eeeb1b9bde817175ea3f74644))
* **test:** proxy_completions_queue_overflow_returns_503テストを一時的に無効化 ([de4b9d3](https://github.com/akiojin/runtime-router/commit/de4b9d3d7fef24f3c9868783a05b5800d0190b3e))
* **test:** resolve test isolation issues with AUTH_DISABLED env var ([285748d](https://github.com/akiojin/runtime-router/commit/285748d28fa72414ffd79c6b7b782228055c780b))
* **tests:** reference support module via crate to avoid duplicate loads ([2b17509](https://github.com/akiojin/runtime-router/commit/2b175098b9e2a806d2a642d2f632efbb6128956d))
* **tests:** silence missing-docs and unexpected cfg warnings ([bd29a5f](https://github.com/akiojin/runtime-router/commit/bd29a5f0c750e00906a77ba213cf259056813814))
...
## [1.4.1](https://github.com/akiojin/runtime-router/compare/v1.4.0...v1.4.1) (2025-11-14)
...
* **installer:** mark windows components as 64-bit ([2c0e10f](https://github.com/akiojin/runtime-router/commit/2c0e10fac0dcd96ec2da8b7b619983d8059fb909))
* **lint:** needless_borrows_for_generic_argsエラーを修正 ([f05bc48](https://github.com/akiojin/runtime-router/commit/f05bc481166c05bc2f0c7c6a31359f5cc781ccb3))
...
* **ui:** モデル管理ダッシュボードUIを実装 (T036-T038) ([4b4ccb7](https://github.com/akiojin/runtime-router/commit/4b4ccb77261482550d9b9dcbebec4a196ec0ed0b))

## [1.2.3](https://github.com/akiojin/runtime-router/compare/v1.2.2...v1.2.3) (2025-11-14)


### Bug Fixes

* **ci:** allow wix downgrade on windows ([698c7f6](https://github.com/akiojin/runtime-router/commit/698c7f657517c21ba88fc8a0e145b93cbdd12aac))
* **ci:** configure macos x86 linker ([fe3af80](https://github.com/akiojin/runtime-router/commit/fe3af8042fd83a8a1ce2d19bc96928ec832a9ede))

## [1.2.2](https://github.com/akiojin/runtime-router/compare/v1.2.1...v1.2.2) (2025-11-14)


### Bug Fixes

* **ci:** macOSリンカ設定とbackmerge制御を復元 ([f5af5ae](https://github.com/akiojin/runtime-router/commit/f5af5ae002a395dcce30f4edaeea7dba2ba9ef8e))
* **docs:** stabilize markdownlint table rules ([7a86925](https://github.com/akiojin/runtime-router/commit/7a8692570885cb4b44e0027dafe2285032b90c24))
* **lint:** normalize markdown tables and lint tooling ([0af3f37](https://github.com/akiojin/runtime-router/commit/0af3f37e7caf1d4922e9e4f1ae66f986ee1e8167))

## [1.2.1](https://github.com/akiojin/runtime-router/compare/v1.2.0...v1.2.1) (2025-11-13)
...
* **docker:** change global package installation from pnpm to npm ([b86a34f](https://github.com/akiojin/runtime-router/commit/b86a34f7fe2622fd83e083412cec7ddb690771e7))
* **docker:** update .codex volume mapping and sync auth.json from host ([340f409](https://github.com/akiojin/runtime-router/commit/340f409080e8944e6bd0f11b3237bc16dcd6f226))
...
* **docs:** CHANGELOGの連続空白行を修正し、worktreesを除外 ([9b4b7b0](https://github.com/akiojin/runtime-router/commit/9b4b7b00d98910157b78fbe01756e0f83a870c8b))
* **docs:** ドキュメントの表現を改善 ([44dba3e](https://github.com/akiojin/runtime-router/commit/44dba3eacce6bc1a98514f14da03f8d915adeb97))
* **release:** add GH_TOKEN to trigger release.yml workflow ([8bbbd89](https://github.com/akiojin/runtime-router/commit/8bbbd890d4bf84070b584b679b5af1caa0bb557b))
* **release:** add patch release test marker ([52ab19d](https://github.com/akiojin/runtime-router/commit/52ab19d5d9a3def30e5855808c180cf2bb7b4bdb))
* **release:** align workflows with unity repo ([7ec2363](https://github.com/akiojin/runtime-router/commit/7ec2363290560ce7a916f1b8caeabe4867e78fc7))
* **release:** append patch release verification note ([d1dec52](https://github.com/akiojin/runtime-router/commit/d1dec529c9047b1c8c84e2bbbb3da5941d61035a))
* **release:** explicitly trigger release.yml via gh workflow run ([bd990a4](https://github.com/akiojin/runtime-router/commit/bd990a4c8f0e26ebaf3efb86cfafdde0118f35ba))
* **release:** explicitly use PERSONAL_ACCESS_TOKEN for git push ([6b981c2](https://github.com/akiojin/runtime-router/commit/6b981c2108dc2cc28c58f7b8d7651668a49351e6))
* **release:** remove ANSI color codes before version extraction ([12afb18](https://github.com/akiojin/runtime-router/commit/12afb18c8b24d4ca4ba878d544c7840fc71b5c96))
* **release:** remove redundant release shell ([971c5ea](https://github.com/akiojin/runtime-router/commit/971c5ea1c6d8f65d6a6eeaadbd6566150121962c))
* **release:** revert to simple form matching unity-mcp-server v2.35.1 ([919a2d8](https://github.com/akiojin/runtime-router/commit/919a2d86648d486bee2b7deec26a27e2fb6f6a19))
* **release:** unity mcp serverフローに合わせて更新 ([df0c7e9](https://github.com/akiojin/runtime-router/commit/df0c7e9569e011268e48b112f240462dcf42d574))
* **release:** unity-mcp-serverと完全に同じリリースフローに統一 ([f4219d0](https://github.com/akiojin/runtime-router/commit/f4219d053512cf5149855dce332c855bbeadc52b))
* **release:** unity-mcp-serverと完全に同じリリースフローに統一 ([eb9da11](https://github.com/akiojin/runtime-router/commit/eb9da11ab728e9dfc65f0d93bfb26c3b62fdbab6))
* **release:** unity-mcp-serverと完全に同じリリースフローに統一 ([cc142b2](https://github.com/akiojin/runtime-router/commit/cc142b297487a143af7c1c802f2ddfa6b627adbf))
* **release:** wait and use REST API for workflow dispatch ([2d05fe9](https://github.com/akiojin/runtime-router/commit/2d05fe9a8c8de2af879b291305a9fc769ce9e779))
* **release:** yaml syntax error in merge commit message ([c32ccf7](https://github.com/akiojin/runtime-router/commit/c32ccf77d045297a22cb57eb8818097131166bfd))
* **workflow:** draftチェック検証を安定化 ([0975ec5](https://github.com/akiojin/runtime-router/commit/0975ec592f6c7cdafd0aa793074cb943e5d383a4))
* **workflow:** PAT必須でauto-merge権限を保証 ([f5aed47](https://github.com/akiojin/runtime-router/commit/f5aed47040ca097f46c05b37c3ab218fe69f084a))
* **workflow:** PERSONAL_ACCESS_TOKENを使用 ([0cb6e2c](https://github.com/akiojin/runtime-router/commit/0cb6e2c3d1ea59a183ae8838da2a34a3d5d66ee7))


### Features

* **docs:** add gpu-aware routing feature description ([c98e193](https://github.com/akiojin/runtime-router/commit/c98e1939f8bd5906da673c198167c15acd7d0793))
* **hooks:** claude-worktreeのフック機構を統合 ([27275e0](https://github.com/akiojin/runtime-router/commit/27275e05a89602f49c8e322a07a75892b1b6fa54))
* **release:** add automated release workflows ([23391e3](https://github.com/akiojin/runtime-router/commit/23391e38c64916288904e3273191f86068dd3b7e))
* **workflow:** auto-mergeフローをupstream同期 ([45c81be](https://github.com/akiojin/runtime-router/commit/45c81befa5c4eaa6523e5b1bee7a312d6120848d))

## [1.0.1-alpha.3](https://github.com/akiojin/runtime-router/compare/v1.0.1-alpha.2...v1.0.1-alpha.3) (2025-11-07)

### Bug Fixes

* **docker:** change global package installation from pnpm to npm ([b86a34f](https://github.com/akiojin/runtime-router/commit/b86a34f7fe2622fd83e083412cec7ddb690771e7))

## [1.0.1-alpha.2](https://github.com/akiojin/runtime-router/compare/v1.0.1-alpha.1...v1.0.1-alpha.2) (2025-11-07)

### Bug Fixes

* **docker:** update .codex volume mapping and sync auth.json from host ([340f409](https://github.com/akiojin/runtime-router/commit/340f409080e8944e6bd0f11b3237bc16dcd6f226))

## [1.0.1-alpha.1](https://github.com/akiojin/runtime-router/compare/v1.0.0...v1.0.1-alpha.1) (2025-11-06)
...
* **checks:** check-tasks.shを引数オプショナルに変更 ([8ec63a6](https://github.com/akiojin/runtime-router/commit/8ec63a6631a38bc8c8daaa8d17c3e4e5835b9892))
* **checks:** check-tasks.shを引数オプショナルに変更 ([0706868](https://github.com/akiojin/runtime-router/commit/0706868c86d7e021adfcadf6e8b3e61258e64aa8))
* **ci:** commitlint設定を簡素化 - @commitlint/config-conventional依存を削除 ([0b56135](https://github.com/akiojin/runtime-router/commit/0b561354c6aab4e4e1f6c667a9868f3309914571))
* **ci:** disable pipefail for tar|head pipe ([89b699a](https://github.com/akiojin/runtime-router/commit/89b699ae150c65046838af937e1b6e24fb6eea65))
* **ci:** tar pipe fix ([2f0cdd6](https://github.com/akiojin/runtime-router/commit/2f0cdd6c0e6fe1ff9c7ec9b3462a4550b50d2757))
* **ci:** tar+headパイプブレイクエラーを修正 ([f2227a3](https://github.com/akiojin/runtime-router/commit/f2227a3d7770b6385f0676e7188412d76d560f2c))
* **ci:** tar|headパイプでpipefailを一時無効化 ([d8b1264](https://github.com/akiojin/runtime-router/commit/d8b1264bda2f7359169a87251bad6bff2b27411b))
* **ci:** ブランチ操作ブロックの堅牢化 ([699ac51](https://github.com/akiojin/runtime-router/commit/699ac518012f3eeb1f4403df6b13126c134fd1fd))
* clippy指摘を解消 ([f0cba57](https://github.com/akiojin/runtime-router/commit/f0cba578679e5f6d6dac899d979666e865989f3e))
...
* **dashboard:** renderAgents中の未定義変数エラーを解消 ([ee48afe](https://github.com/akiojin/runtime-router/commit/ee48afed8906eb4a5d04141537d714e40e3fa37a))
* **dashboard:** ダークモードでのテキスト可視性を改善 ([97f8808](https://github.com/akiojin/runtime-router/commit/97f880848be26689b7479a1cf207824191c65967))
* **dashboard:** 静的アセットの404とChart.js SRIを修正 ([9a76c68](https://github.com/akiojin/runtime-router/commit/9a76c68014648db194e7349c411fd478916fdca8))
* **lint:** Clippyエラーとテスト失敗を修正 ([fb13bbf](https://github.com/akiojin/runtime-router/commit/fb13bbf18d240682919eab0b49aa6c8d41c093b6))
* markdownlintエラーを修正 ([3b9ce0d](https://github.com/akiojin/runtime-router/commit/3b9ce0d4f7476cf41530bd63b21623a8d21501a1))
* **quality:** 品質チェック対応＆テスト修正（T033-T037） ([ed919f2](https://github.com/akiojin/runtime-router/commit/ed919f241664f835b2fc0576693673ecbc4c1ae5))
* **release:** rebuild artifacts after version bump ([c5e59be](https://github.com/akiojin/runtime-router/commit/c5e59bee76ab46235073f987d1ac582c77c5bfe4))
* **release:** release-binaries.ymlの環境変数評価を修正 ([b126adc](https://github.com/akiojin/runtime-router/commit/b126adcd76d1d447c06bcbd532dd2e3d0f4c6f5e))
* **release:** release-binaries.ymlの環境変数評価を修正 ([a1bd31e](https://github.com/akiojin/runtime-router/commit/a1bd31e7de1fee200d2067b9ab4d246b5e224de7))
* **release:** tarアーカイブ検証でのstdout書き込みエラーを修正 ([3a7e5c9](https://github.com/akiojin/runtime-router/commit/3a7e5c97d1b5bbbf6369da063b25b0f1697ec4f7))
* **release:** tarアーカイブ検証のstdout書き込みエラー修正 ([5f4d37f](https://github.com/akiojin/runtime-router/commit/5f4d37f4e3dcbc13da7bc21441fafc7ef18af0e1))
...
* **ui:** リクエスト履歴セクションの見出しとレイアウトを改善 ([72772cb](https://github.com/akiojin/runtime-router/commit/72772cbe67669767eddfc566b1e5e799764e6374))
* **ui:** リクエスト履歴を新しい順に表示 ([fde64d9](https://github.com/akiojin/runtime-router/commit/fde64d94d29f8e839b2c117875e9ad6e1da59046))
* コードフォーマットを修正 ([4a756aa](https://github.com/akiojin/runtime-router/commit/4a756aaa23920027c50657e0ac4955ca6f9c5537))
* コンパイルエラーとフォーマット問題を修正 ([e257b7a](https://github.com/akiojin/runtime-router/commit/e257b7a52cfe3672163e05aae774563238c14d3a))
* ブランチ自動作成を無効化（ユーザーが手動でブランチ作成する） ([e7c31f6](https://github.com/akiojin/runtime-router/commit/e7c31f61a2c5dc9cdd6b4555fa643876b0613e1e))
...
* **dashboard:** ノード一覧のソートを実装 ([abc6a0e](https://github.com/akiojin/runtime-router/commit/abc6a0e56ff579d67bde12f9c91b453332ac74d1))
* **dashboard:** ノード一覧のフィルタを追加 ([eb8778e](https://github.com/akiojin/runtime-router/commit/eb8778e15790d6c31f2dd90e39fb7ec1d02d647d))
* **dashboard:** ノード設定UIの骨組みを追加 ([7af0a35](https://github.com/akiojin/runtime-router/commit/7af0a356e0a5284578a7d992933e21cd543135ff))
* **dashboard:** ノード詳細モーダルを追加 ([baaa309](https://github.com/akiojin/runtime-router/commit/baaa309f6bf570717e1ab3a204f1583d825a7184))
* **dashboard:** エクスポート機能と強制切断UIを追加 ([afd3933](https://github.com/akiojin/runtime-router/commit/afd3933c95c30a740a1ce4251d0a8cf0828b3e6a))
* **dashboard:** ダッシュボードAPIとUIを追加 ([607bc2f](https://github.com/akiojin/runtime-router/commit/607bc2fb251e521383544dff880d03b07e178fb9))
* **dashboard:** ページネーションを追加 ([74d815e](https://github.com/akiojin/runtime-router/commit/74d815e90299da1c1f9fa0846f8bc204cea6b10d))
* **dashboard:** リクエスト履歴API実装（T023-T026） ([59e5fc0](https://github.com/akiojin/runtime-router/commit/59e5fc0c5ee857db0ffb0ae5fbec1709f2b2d654))
* **dashboard:** リクエスト履歴チャートを追加 ([b4a593e](https://github.com/akiojin/runtime-router/commit/b4a593e76a1073a1fee49c5b09729a7366edd1fa))
* **dashboard:** 取得と描画時間を可視化 ([e97bfed](https://github.com/akiojin/runtime-router/commit/e97bfedbab8319a21202603ec289f4c45938698d))
* **dashboard:** 概要APIでポーリングを1リクエストに集約 ([72626ac](https://github.com/akiojin/runtime-router/commit/72626ac549cff2b5ca663232a7fdf24a8b6d91fe))
* **gpu:** Apple Silicon GPU検出をMetal APIで実装 ([2363d35](https://github.com/akiojin/runtime-router/commit/2363d3581d266838e2c0a2f00abf3bce8c1dd774))
* **gpu:** Docker環境用に環境変数でGPU情報を設定可能に ([d38cb23](https://github.com/akiojin/runtime-router/commit/d38cb234a3c172827e1bc6b204cc18e1823c7c2e))
* **gpu:** GPU必須ノード登録要件の実装 ([c9c7e1f](https://github.com/akiojin/runtime-router/commit/c9c7e1f816662ee353ccfe092bfc217bab6113a7))
* **gpu:** GPU能力スコア機能を追加 ([cd3147a](https://github.com/akiojin/runtime-router/commit/cd3147ab5a70b225fde43bc98eb0180a1de21d6b))
* **gpu:** GPU詳細メトリクス3フィールド追加 ([5fcc69e](https://github.com/akiojin/runtime-router/commit/5fcc69e237b0910db5d475a9dd00c7e521074a2e))
* GPU登録要件を全体に適用 ([42e9afd](https://github.com/akiojin/runtime-router/commit/42e9afde69ec38dcf80b544f6b5c5e08d05c8e8f))
* **heartbeat:** track response time metrics ([91d90a3](https://github.com/akiojin/runtime-router/commit/91d90a394aa7bab5b8d721478becbdd9db41a6c1))
* improve gpu fallback and docker memory ([3ddfdc7](https://github.com/akiojin/runtime-router/commit/3ddfdc76503448f3c6f28d5a83c816f0fc2136c4))
* **infra:** developブランチ作成とブランチ保護設定完了 ([ad3a83a](https://github.com/akiojin/runtime-router/commit/ad3a83a560957bd75771594224308af1d3ff02b2))
* **metrics:** add gpu telemetry pipeline ([16c4e68](https://github.com/akiojin/runtime-router/commit/16c4e68c1a6dbe96789d63e98615c00b1ffc5866))
* **metrics:** annotate snapshots with freshness ([b96d7c6](https://github.com/akiojin/runtime-router/commit/b96d7c64c321d0822b66005cb203d6b8fd172128))
* **metrics:** expose metrics summary endpoint ([166ddbd](https://github.com/akiojin/runtime-router/commit/166ddbd67f1b22ed848c716ee5f16d1657eb1a76))
* **metrics:** refine metric freshness handling ([10c717e](https://github.com/akiojin/runtime-router/commit/10c717eec8ddd619cb8ae6db5b39626da7fd09e8))
* **plan:** LLM runtime Router Systemの実装計画を作成 ([ea2da6b](https://github.com/akiojin/runtime-router/commit/ea2da6b2689d58f8879240b74d59646765e501b4))
* **proxy:** stream openai responses ([27178c6](https://github.com/akiojin/runtime-router/commit/27178c6b58ee3dd1b4126bfffc99e77c8fe1111e))
* **proxy:** リクエスト/レスポンスキャプチャ実装（T020-T022） ([120fc91](https://github.com/akiojin/runtime-router/commit/120fc911c49c503056e43f635c4ee2504f7e7c1b))
* **release:** 完全自動化リリースシステムの実装 ([70a9f2e](https://github.com/akiojin/runtime-router/commit/70a9f2edaf47ddf79028952394c6ab0120aa3376))
* **setup:** Phase 3.1完了 - Cargo Workspaceセットアップ (T001-T008) ([e3f5b64](https://github.com/akiojin/runtime-router/commit/e3f5b64a43d8f31753421af4bbf45240ff229662))

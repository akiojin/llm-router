...
13. **リリース配布形式の整合性**: GitHubリリースに添付される配布物は、Unix系プラットフォーム向けを`.tar.gz`、Windows向けを`.zip`で提供し、それぞれにCoordinator/Agentバイナリと主要ドキュメント（`README.md`、`README.ja.md`、`LICENSE`）が含まれている

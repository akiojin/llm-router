...
9. エージェント登録完了後、対応モデル5件（gpt-oss:120b/20b、gpt-oss-safeguard:20b、qwen3-coder:30b、glm4:9b-chat-q4_K_M）が当該エージェントで自動ダウンロード・常駐状態になること（ダッシュボードまたは API で確認可能であること）
